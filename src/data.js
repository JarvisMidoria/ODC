export const site = {
  ...
  addresses: [
    {
      city: "Casablanca",
      address: "1, Avenue Dr Mohamed Sijelmassi",
      note: "ex Avenue du Phare",
      href: "https://maps.google.com/?q=1+Avenue+Dr+Mohamed+Sijelmassi+Casablanca"
    },
    {
      city: "Rabat",
      address: "10, Avenue du 16 Novembre - Quartier Agdal",
      note: "Showroom résidentiel et prescription",
      href: "https://maps.google.com/?q=10+Avenue+du+16+Novembre+Agdal+Rabat"
    },
    {
      city: "Tanger",
      address: "5-6 angle Rue Ibnou Zaidoune et rue Kortoba - Res. Dar Baida IV",
      note: "Sélection projets et collections",
      href: "https://maps.google.com/?q=Rue+Ibnou+Zaidoune+Rue+Kortoba+Tanger"
    }
  ]
};
...
export const products = [
  {
    ...
    name: "1830 col. 09",
    category: "recycle",
    categoryLabel: "Recyclé",
    price: 245,
    description:
      "Tissu obtenu à partir du traitement des résidus de production textile sans agents chimiques nocifs.",
    composition: "Recyclé premium",
    martindale: "25.000",
    lightfastness: "4/5",
  ...
  },
  {
    ...
    price: 320,
    originalPrice: 450,
    description: "Textile texturé avec relief subtil, adapté aux espaces résidentiels et hôteliers.",
    composition: "41% CO 36% PL 23% PC",
    martindale: "25.000",
    lightfastness: "4/5",
  ...
  },
  {
    ...
    categoryLabel: "Recyclé",
    price: 245,
    description: "Une déclinaison plus chaude et mate de la gamme 1830, pensée pour salons et sièges.",
    composition: "Recyclé premium",
    martindale: "25.000",
    lightfastness: "4/5",
    tags: ["Recyclé"],
  ...
  },
  {
    ...
    name: "2319 col. 17",
    category: "jacquard",
    categoryLabel: "Jacquard",
    price: 320,
    originalPrice: 450,
    description: "Une matière expressive avec relief marqué, pensée pour un intérieur plus décoratif.",
    composition: "41% CO 36% PL 23% PC",
    martindale: "25.000",
    lightfastness: "4/5",
  ...
  },
  {
    ...
    price: 320,
    originalPrice: 450,
    description: "Référence douce et versatile, adaptée aux projets résidentiels comme aux lounges d'hôtel.",
    composition: "41% CO 36% PL 23% PC",
    martindale: "25.000",
    lightfastness: "4/5",
  ...
  },
  {
    ...
    categoryLabel: "Lin",
    price: 260,
    description: "Lin texturé pour assises et rideaux à l'expression plus naturelle.",
    composition: "Lin mélangé",
    martindale: "20.000",
    lightfastness: "4/5",
    tags: ["Lin"],
  ...
  },
  {
    ...
    categoryLabel: "Recyclé",
    price: 245,
    description: "Déclinaison claire de la gamme 1830, propre à une lecture plus architecturale.",
    composition: "Recyclé premium",
    martindale: "25.000",
    lightfastness: "4/5",
    tags: ["Recyclé", "Clair"],
  ...
  },
  {
    slug: "1807-col-1",
    name: "1807 col. 1",
    category: "tissu-enduit",
    categoryLabel: "Tissu enduit",
    price: 180,
    originalPrice: 220,
    description: "Une solution résistante à l'usage avec une lecture plus technique pour le contract.",
    composition: "Tissu enduit",
    martindale: "30.000",
    lightfastness: "4/5",
